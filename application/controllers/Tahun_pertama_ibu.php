...
class Tahun_pertama_ibu extends CI_Controller
{
    ...
    public function index()
    {
        ...
        $this->load->view('tahun_pertama_ibu/tbl_tahun_pertama_ibu_list', $data);
    }
    ...
    public function read($id) 
    {
		...
		'des' => $row->des,
            ...
            $this->load->view('tahun_pertama_ibu/tbl_tahun_pertama_ibu_read', $data);
        } else {
    ...
    public function create() 
    {
        ...
        $this->load->view('tahun_pertama_ibu/tbl_tahun_pertama_ibu_form', $data);
    }
