...
class Tahun_kelima extends CI_Controller
{
    ...
    public function index()
    {
        ...
        $this->load->view('tahun_kelima/tbl_tahun_kelima_list', $data);
    }
    ...
    public function read($id) 
    {
		...
		'des' => $row->des,
            ...
            $this->load->view('tahun_kelima/tbl_tahun_kelima_read', $data);
        } else {
    ...
    public function create() 
    {
        ...
        $this->load->view('tahun_kelima/tbl_tahun_kelima_form', $data);
    }
