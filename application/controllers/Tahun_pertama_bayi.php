...
class Tahun_pertama_bayi extends CI_Controller
{
    ...
    public function index()
    {
        ...
        $data['konten'] = 'tahun_pertama_bayi/tbl_tahun_pertama_bayi_list';
    ...
    public function read($id) 
    {
		...
		'des' => $row->des,
            ...
            $data['konten'] = 'tahun_pertama_bayi/tbl_tahun_pertama_bayi_read';
            $this->load->view('templates/admin/index', $data);
        } else {
    ...
    public function create() 
    {
        ...
        $data['konten'] = 'tahun_pertama_bayi/tbl_tahun_pertama_bayi_form';
        $this->load->view('templates/admin/index', $data);
    }
