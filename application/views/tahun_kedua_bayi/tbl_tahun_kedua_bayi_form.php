        ...
        <h2 style="margin-top:0px">Tbl_tahun_kedua_bayi <?php echo $button ?></h2>
	    ...
	    <div class="form-group">
            <label for="varchar">Juli <?php echo form_error('juli') ?></label>
            <input type="text" class="form-control" name="juli" id="juli" placeholder="Juli" value="<?php echo $juli; ?>" />
        </div>
	    <div class="form-group">
	    ...
	    <input type="hidden" name="id_tahun_kedua" value="<?php echo $id_tahun_kedua; ?>" /> 
	    <button type="submit" class="btn btn-primary"><?php echo $button ?></button> 
	    <a href="<?php echo site_url('tahun_kedua_bayi') ?>" class="btn btn-default">Cancel</a>
	</form>
