        ...
        <h2 style="margin-top:0px">Tbl_tahun_ketiga <?php echo $button ?></h2>
	    ...
	    <input type="hidden" name="id_tahun_ketiga" value="<?php echo $id_tahun_ketiga; ?>" /> 
	    <button type="submit" class="btn btn-primary"><?php echo $button ?></button> 
	    <a href="<?php echo site_url('tahun_ketiga') ?>" class="btn btn-default">Cancel</a>
	</form>
