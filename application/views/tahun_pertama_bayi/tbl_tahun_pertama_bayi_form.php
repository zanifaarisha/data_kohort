        ...
        <h2 style="margin-top:0px">Tbl_tahun_pertama_bayi <?php echo $button ?></h2>
	    ...
	    <input type="hidden" name="id_tahun_pertama" value="<?php echo $id_tahun_pertama; ?>" /> 
	    <button type="submit" class="btn btn-primary"><?php echo $button ?></button> 
	    <a href="<?php echo site_url('tahun_pertama_bayi') ?>" class="btn btn-default">Cancel</a>
	</form>