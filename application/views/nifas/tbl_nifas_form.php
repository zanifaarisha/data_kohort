...
<html>
    ...
    <body>
	    ...
	    <div class="form-group">
            ...
            <input type="text" class="form-control" name="6jam_3hr" id="6jam_3hr" placeholder="6jam 3hr" value="<?php echo $6jam_3hr; ?>" />
        </div>
	    <div class="form-group">
            <label for="varchar">4 28hr <?php echo form_error('4_28hr') ?></label>
            <input type="text" class="form-control" name="4_28hr" id="4_28hr" placeholder="4 28hr" value="<?php echo $4_28hr; ?>" />
        </div>
	    <div class="form-group">
            <label for="varchar">29 42hr <?php echo form_error('29_42hr') ?></label>
            <input type="text" class="form-control" name="29_42hr" id="29_42hr" placeholder="29 42hr" value="<?php echo $29_42hr; ?>" />
        </div>
	    <div class="form-group">
